...
import 'package:meditation_app_ui/screens/welcome/config/palette.dart';
      ...
      child: Column(
        children: [
          buildTextField(MaterialCommunityIcons.account_outline,
              "Kullanıcı Adı", false, false),
          buildTextField(
              MaterialCommunityIcons.email_outline, "email", false, true),
          buildTextField(
              MaterialCommunityIcons.lock_outline, "şifre", true, false),
          Padding(
